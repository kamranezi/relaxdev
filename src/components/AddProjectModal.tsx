    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="bg-[#111] border-gray-800 text-white sm:max-w-[600px] w-[95vw] max-h-[90vh] overflow-y-auto overflow-x-hidden custom-scrollbar p-4 sm:p-6">
        ...
        <div className="space-y-6 overflow-hidden">
                      ...
                      filteredRepos.map((repo) => (
                        ...
                        >
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-6 text-xs opacity-0 group-hover:opacity-100 transition-opacity text-gray-400 flex-shrink-0 ml-2"
                          >
                            Select
                          </Button>
                        </div>
          ...
          <div className="space-y-3 pt-4 border-t border-gray-800 overflow-hidden">
            <div className="space-y-2 w-full overflow-hidden">
              ...
              <Input
                ...
                className="bg-black/50 border-gray-700 w-full"
              />
            </div>
          ...
          <div className="pt-4 border-t border-gray-800 w-full overflow-hidden">
